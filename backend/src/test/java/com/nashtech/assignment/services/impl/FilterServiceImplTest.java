...
class FilterServiceImplTest {
        ...
        void setup() {
                ...
                filterServiceImpl = FilterServiceImpl.builder().assetRepository(assetRepository)
                                .assignAssetRepository(assignAssetRepository).assignAssetMapper(assignAssetMapper)
                                .assetMapper(assetMapper).pageableUtil(pageableUtil)
